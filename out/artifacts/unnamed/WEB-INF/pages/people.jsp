...
<c:if test="${!empty read}">
    <table class="tg">
        ...
        <c:forEach items="${read}" var="person">
            <tr>
                <td>${person.id}</td>
                <td><a href="/bookdata/${person.id}" target="_blank">${person.fname}</a></td>
                <td>${person.lname}</td>
                <td>${person.age}</td>
                <td><a href="<c:url value='/edit/${person.id}.form'/>">Edit</a></td>
                <td><a href="<c:url value='/delete/${person.id}.form'/>">Delete</a></td>
            </tr>
        </c:forEach>
    </table>
</c:if>
